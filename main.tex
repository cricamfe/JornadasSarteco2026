...
\usepackage{tikz}
\usepackage{makecell}
\usetikzlibrary{shapes,arrows,positioning,calc,fit,backgrounds,matrix,arrows.meta,shapes.geometric,patterns,decorations.pathreplacing,babel}
...
\title{CASTM: An API for Accelerating Zero-Knowledge Proof Kernels on CGRA Architectures}
