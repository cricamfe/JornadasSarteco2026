...
\usepackage{xcolor}
\usepackage{caption}
\captionsetup{font=footnotesize, aboveskip=6pt}
...
\makeatletter
\let\castmoldthebibliography\thebibliography
\renewcommand{\thebibliography}[1]{%
  \castmoldthebibliography{#1}%
  \footnotesize
...
\input{paper_metrics_manual}
\input{generated/paper_metrics_auto}
\input{generated/merkle_eval_metrics_auto}
...
This work was supported by the Ministry of Science, Innovation and Universities, Government of Spain (Grant Numbers TED2021-131527B-I00,  PID2022-136575OB-I00 and TSI-069100-2023-0013).
