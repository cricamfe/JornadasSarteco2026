...
\begin{tikzpicture}[
  ...
  act/.style={pe, fill=black!55, text=white,
             font=\fontsize{5.5}{5.7}\selectfont,
             text width=6.6mm, align=center,
             text height=1.1ex, text depth=0.25ex},
  mid/.style={pe, fill=black!14},
  idl/.style={pe, fill=white, text=black!30},
  carry/.style={-{Triangle[length=5pt,width=5pt]}, line width=1.0pt, black,
...
\node[act] (c01) at (1*\sp, 0) {\makecell{+\\carry}};
\node[act] (c02) at (2*\sp, 0) {\makecell{+\\carry}};
...
% Carry chain arrows kept inside row 0, above the text baseline.
\draw[carry, black] ([xshift=8pt, yshift=0pt]c00.east) -- ([xshift=6pt, yshift=0pt]c01.west);
\draw[carry, black] ([xshift=8pt, yshift=0pt]c01.east) -- ([xshift=6pt, yshift=0pt]c02.west);
\draw[carry, black] ([xshift=8pt, yshift=0pt]c02.east) -- ([xshift=6pt, yshift=0pt]c03.west);
